...
public class ProductController {
	...
	public ResponseEntity<WSDiscount> getProductDiscount(@RequestParam("id") String id) {
		ResponseEntity<WSDiscount> responseEntity = baseRestOutboundProcessor.get("http://discount-service.com?id=" + id, null, WSDiscount.class, new HashMap<>());
	...
	public Product getProduct(@PathVariable String productCode) {
		...
		product.setId("12225");
	 		product.setProductCode("112");
	 		product.setProductName("Men White Trouser Green Suit");
